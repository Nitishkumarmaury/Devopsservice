export const siteConfig = {
  name: "DevOps Service Studio",
  legalName: "DevOps Service Studio",
  ...
  description:
    "Production-ready DevOps and cloud engineering services for SaaS companies and software teams. Cloud infrastructure, CI/CD, Docker, Kubernetes, monitoring, migrations, and production support.",
  social: {
    linkedin: "",
    github: "",
  },
