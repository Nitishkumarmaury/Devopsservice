...
export function TechnologyStrip() {
  return (
    <section aria-label="Technology references" className="relative z-10 border-y border-rose-100 bg-white/80 py-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_12%_50%,rgba(66,174,181,0.12),transparent_26%),radial-gradient(circle_at_88%_35%,rgba(214,107,154,0.12),transparent_28%)]" />
