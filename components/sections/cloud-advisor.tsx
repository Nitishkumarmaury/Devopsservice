  ...
  return (
    <div className="relative overflow-hidden rounded-lg border border-rose-100 bg-white/86 p-5 shadow-[0_30px_110px_rgba(15,34,48,0.12)]">
      ...
      <div className="relative space-y-4">
        ...
        <div className="h-[480px] rounded-lg border border-rose-100 bg-white/70" />
      </div>
    </div>
  );
}
      ...
      <Container className="relative">
        <div className="grid gap-10 xl:grid-cols-[0.82fr_1.18fr] xl:items-start">
          <div className="xl:sticky xl:top-24">
            ...
            <p className="mt-6 font-mono text-xs font-semibold uppercase tracking-[0.22em] text-rose-700">
              Cloud Architecture Advisor
            </p>
            <h2 className="mt-3 text-4xl font-semibold leading-[1.02] tracking-[-0.035em] text-[var(--text-primary)] sm:text-5xl">
            ...
            <div className="mt-6 rounded-lg border border-rose-100 bg-white/68 p-4">
            ...
            <div className="mt-8 space-y-3">
              {useCases.map((useCase) => (
                <div
                  key={useCase}
                  className="flex gap-3 rounded-lg border border-rose-100 bg-white/68 p-4 text-sm text-[var(--text-secondary)]"
                >
