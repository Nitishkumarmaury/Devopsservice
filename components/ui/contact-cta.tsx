...
export function ContactCta({
  ...
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(135deg,#d66b9a_0%,#a76fc4_48%,#7667d8_100%)] py-16 text-white sm:py-20">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_20%,rgba(255,255,255,0.2),transparent_30%),radial-gradient(circle_at_86%_30%,rgba(255,255,255,0.12),transparent_32%)]" />
