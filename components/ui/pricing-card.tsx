  ...
  return (
    <article
      className={cn(
        ...
        featured && "border-rose-300/60 shadow-[0_24px_80px_rgba(77,163,255,0.16),0_20px_70px_rgba(15,34,48,0.1)]",
      )}
    >
      {featured ? (
      ...
      <p className="mt-1 text-sm text-[var(--text-muted)]">Extra approved work: {hourly}</p>
