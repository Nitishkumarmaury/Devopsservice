...
export function ServiceCard({ title, description, visual, details, Icon, accent, children }: Readonly<ServiceCardProps>) {
  return (
    <article className="aurora-panel group relative flex h-full flex-col overflow-hidden rounded-[22px] p-6 transition duration-200 hover:-translate-y-1 hover:border-rose-300/50">
      ...
      <div className="mt-auto pt-6">
        <div className="rounded-2xl border border-rose-100 bg-white/62 p-4">
