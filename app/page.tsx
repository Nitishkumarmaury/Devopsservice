...
export default function Page() {
  return (
    <SiteFrame>
      ...
      <section className="relative overflow-hidden border-y border-[#d6ebff]/10 bg-[var(--background-soft)] py-16 sm:py-24">
        <Container>
          <SectionIntro eyebrow="Learning hub" title="Guides that clarify technical decisions.">
            Concise explanations for buyers researching DevOps, cloud migration, DevSecOps, automation, and production
            reliability before choosing an implementation partner.
          </SectionIntro>
          <StaggerReveal className="mt-10 grid gap-5 lg:grid-cols-4">
            {seoArticles.map((article) => (
              <article key={article.slug} className="min-w-0 rounded-[18px] border border-[#d6ebff]/12 bg-[#0d2338]/82 p-5 shadow-[var(--shadow-soft)] [overflow-wrap:anywhere] sm:p-6">
                ...
                <h3 className="mt-4 text-xl font-semibold text-[var(--text-primary)]">{article.h1}</h3>
