        ...
        <Container>
          ...
          <StaggerReveal className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {capabilityGroups.map((group) => (
              <article key={group.title} className="flex h-full flex-col justify-between rounded-[24px] border border-[var(--border)] bg-white p-6 shadow-[var(--shadow-soft)] transition hover:shadow-md">
                <div>
