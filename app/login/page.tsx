...
export default async function LoginPage({ searchParams }: LoginPageProps) {
 ...
 <h2 className="mt-5 text-5xl font-semibold leading-[1.02] tracking-[-0.035em] text-ink sm:text-6xl">
 Login before sharing project details or using the advisor.
 </h2>
 <p className="mt-6 max-w-2xl text-base leading-8 text-ink-secondary">
